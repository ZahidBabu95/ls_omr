    ...
    <div class="bg-white overflow-hidden shadow-sm border border-slate-100 rounded-2xl p-6 max-w-3xl">
        <form action="{{ route('admin.faqs.update', $faq) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="question" required value="{{ old('question', $faq->question) }}" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 font-medium">
            ...
            <div>
                ...
                <textarea name="answer" required rows="5" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">{{ old('answer', $faq->answer) }}</textarea>
            ...
            <div>
                ...
                <input type="number" name="order_index" value="{{ old('order_index', $faq->order_index) }}" class="w-full md:w-1/3 bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
